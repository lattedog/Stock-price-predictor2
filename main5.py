...
Utilize the real encoder-decoder model structure.
...
import lstm5 as lstm
import stock5 as stk
...
#        forecast_horizon = int(forecast_horizon)
        ...
        X_train, y_train, X_test, y_test, train_data, train_scalers, test_data, test_scalers, hold_out = stk.data_split(my_df, rolling_win, forecast_horizon, test_size, stand_norm = True)
...
#            
#            # Fit the model
#        	result = model.fit( [X_train[train_index], y_train[train_index]], 
#                            nb_epoch = epochs, batch_size=int(batch), verbose=1, 
...
#        	cvscores.append(-min(result.history['val_loss']))
        ...
        result = model.fit( x = encoder_input_data,  
...
#        cmodel.fit(train, valid, batch_size = int(batch), verbose = 1,
...
#Best combination of parameters: {'target': -0.07110660260976505, 'params': {'batch': 40.0, 'drop_rate': 0.1, 'n_units': 400.0, 'rolling_window': 20.0}}
#The best validation error is 0.07110660260976505
...
#    epochs = 40
#    batch = 60
#    n_units = 400                   # neurons in hidden layer
#    rolling_window = 20
#    forecast_horizon = 20
#    drop_rate = 0.1
#    
...
## =============================================================================
#    
#    trade_threshold =  0.0    # only when my model predicts the changes 
#                                # between the prediction in 20 days and 
#                                # today's price >= threshold. the trades
#                                # are to be made.
#                                
#                                
#    for trade_threshold in range(5):
#        
#        trade_threshold  = 0.1 * trade_threshold 
#                            
